var INDEX=[
	...
	"[CODEX-Events] Main quest - The Deadly Loop: Break the time loop and kill the boss.",
	...
	"[CODEX-Events] Main quest - The Items: Find the items to explore more and fight the boss.",
